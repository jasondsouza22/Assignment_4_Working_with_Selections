...
print("The count of restaurant within 1000 feet of Historical District is {}".format(restaurant_1000_feet[0]))
...
print("The count of crimes within 500 feet of selected restaurants is {}".format(crimes_500_feet[0]))
...
print("The count of alcohol-related crimes is {}".format(count[0]))
